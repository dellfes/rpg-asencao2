...
$('#addWeaponForm').submit(function (event) {
  ...
  $('#d/good').change(function () {
    if (this.checked) {
      console.log('Modo de good ativado!')
    } else {
      console.log('Modo de good desativado!')
    }
  })
...
function calcDice(ability, dice) {
  ...
  const table = [
    {desastre:20, normal:9, good:2, extreme:1 },
    {desastre:20, normal:12, good:4, extreme:1 },
    {desastre:20, normal:13, good:6, extreme:1 },
    {desastre:20, normal:13, good:8, extreme:1 },
    {desastre:20, normal:14, good:10, extreme:1 },
    {desastre:20, normal:16, good:12, extreme:1 },
